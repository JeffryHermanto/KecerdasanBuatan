...
img_path_1 = '/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/ayam.jpg'
img_path_2 = '/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/watermark.jpg'

# Menyiapkan gambar
gambar = cv2.imread(img_path_1)
plt.imshow(gambar)
...
gb1 = cv2.imread(img_path_1)
gb1 = cv2.cvtColor(gb1, cv2.COLOR_BGR2RGB)
plt.imshow(gb1)
gb2 = cv2.imread(img_path_2)
