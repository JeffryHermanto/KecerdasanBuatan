...
# Menyiapkan gambar
lincoln = cv2.imread('/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/abraham_lincoln.jpeg')
plt.imshow(lincoln)
yani = cv2.imread('/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/ahmad_yani.jpeg')
plt.imshow(yani)
banyak = cv2.imread('/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/banyak_wajah.jpg')
plt.imshow(banyak)

# 6000 features dari haarcascade
wajah_cascade = cv2.CascadeClassifier('/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/haarcascades/haarcascade_frontalface_alt.xml')
...
mata_cascade = cv2.CascadeClassifier('/Users/jeffryhermanto/Documents/Learnings/ITI/Kecerdasan Buatan/haarcascades/haarcascade_eye.xml')
